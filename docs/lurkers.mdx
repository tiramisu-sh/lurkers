...
| PDF | [pypdf](https://pypdf.readthedocs.io/) text extraction (by URL or content-type) | none |
| YouTube | oEmbed (title / channel) + youtube-transcript-api | none |
| Twitter / X | [fxtwitter](https://fxtwitter.com/) public API (incl. fxtwitter/fixupx mirrors) | none |
